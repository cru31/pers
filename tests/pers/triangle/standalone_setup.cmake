# Setup for standalone build of WebGPU triangle2 test
...
# Setup vcpkg for GLFW
if(EXISTS "${PERS_ROOT}/build/vcpkg_installed/x64-windows/share/glfw3")
    list(APPEND CMAKE_PREFIX_PATH "${PERS_ROOT}/build/vcpkg_installed/x64-windows/share")
elseif(EXISTS "${PERS_ROOT}/build/vcpkg_installed/x64-linux/share/glfw3")
    list(APPEND CMAKE_PREFIX_PATH "${PERS_ROOT}/build/vcpkg_installed/x64-linux/share")
elseif(EXISTS "${PERS_ROOT}/build/vcpkg_installed/x64-osx/share/glfw3")
    list(APPEND CMAKE_PREFIX_PATH "${PERS_ROOT}/build/vcpkg_installed/x64-osx/share")
endif()
